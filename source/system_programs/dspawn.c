...
#include <signal.h>
#include <sys/wait.h>
#include <sys/stat.h>    // Added for umask and file permissions
#include <fcntl.h>
#include <string.h>
#include <limits.h>
...
static int daemon_work()
{
    ...
    strcpy(output_file_path, "/home/benjamin-teoh/programming-assignment-1-2024-ci02-r-b/dspawn.log"); 
...
int main() {
    ...
    if (pid == 0) {
        ...
        wait(NULL); // Wait for the intermediate process to exit
    }
